...
export class RestAPIStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        // Functions
        const getDetailByMovieAndAwardFn = new lambdanode.NodejsFunction(
            this,
            "GetDetailByMovieAndAwardFn",
            {
                architecture: lambda.Architecture.ARM_64,
                runtime: lambda.Runtime.NODEJS_16_X,
                entry: `${__dirname}/../lambdas/getDetailByMovieAndAward.ts`,
        ...
        const movieAwardEndpoint = awardBodyEndpoint.addResource("movies")
        const movieIdEndpoint = movieAwardEndpoint.addResource("{movieId}")
        movieIdEndpoint.addMethod(
            "GET",
            new apig.LambdaIntegration(getDetailByMovieAndAwardFn, {proxy: true})
        );
        // Permissions;
        ...
        movieAwardsTable.grantReadData(getDetailByMovieAndAwardFn);
    }
}
